...
class DevicesGroup {
    constructor(wsConnections, mqttBrokerUrl, mqttTopicBase) {
        ...
        this.devices = {
            ...
            clientPalmar: new ClientPalmar(0, [], 0, mqttBrokerUrl, mqttTopicBase, clientTCPData),
            cart: new Cart(0, [], 6, mqttBrokerUrl, mqttTopicBase)
        };
    ...
    updateDevice(deviceType, data, updateType) {
        switch (deviceType) {
            ...
            case 'cart':
                ...
                } else if (updateType === 'removeProduct') {
                    this.devices.cart.removeProduct(data);
                }
                break;
