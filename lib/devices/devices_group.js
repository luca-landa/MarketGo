...
class DevicesGroup {
    constructor(wsConnections, mqttBrokerUrl, mqttTopicBase, tcpAddress, tcpPort) {
        ...
        this.devices = {
            ...
            clientPalmar: new ClientPalmar(0, [], 'Pippo', mqttBrokerUrl, mqttTopicBase, tcpAddress, tcpPort),
            products: products
        };
