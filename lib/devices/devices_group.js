...
class DevicesGroup {
    constructor(wsConnections, mqttBrokerUrl, mqttTopicBase, tcpAddress, clientPalmarTCPPort) {
        ...
        this.devices = {
            ...
            clientPalmar: new ClientPalmar(0, [], 'Pippo', mqttBrokerUrl, mqttTopicBase, tcpAddress, clientPalmarTCPPort),
            products: products
        };
