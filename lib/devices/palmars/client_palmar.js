...
class ClientPalmar extends Palmar {
    ...
    ratingGiven(value) {
        ...
        // TODO remove rating notification from palmar itself
    }
    ...
    createMQTTClient(mqttBrokerUrl, mqttTopicBase) {
        ...
        client.on('connect', () => {
            ...
            client.subscribe(ratingRequestTopic);
            debug.log(`MQTT: clientPalmar (idx:${this.idx}) subscribing to ${ratingRequestTopic}`);
        });
